...
//        Aruco.detectMarkers(originalImage, dict, corners, id, parameters);
    ...
    public Mat augmentImage(Mat originalImage, List<Mat> replacementMat ){
...
//                    //Core.subtract(augmentedMat,originalImage,augmentedMat);
                    ...
                    //this is the light bulb
                        ...
                        imageTopLeft = new Point(0, 0);
                        imageTopRight = new Point(replacementMat.get(1).width(), 0);
                        imageBottomLeft = new Point(0, replacementMat.get(1).height());
                        imageBottomRight = new Point(replacementMat.get(1).width(), replacementMat.get(1).height());
                        points2 = new MatOfPoint2f(imageTopLeft, imageTopRight, imageBottomLeft, imageBottomRight);
                    ...
                    default:
                        ...
                        Log.d("REPLACE", String.valueOf(this.id.get(i, 0)[0]));
                        imageTopLeft = new Point(0, 0);
                        imageTopRight = new Point(replacementMat.get(2).width(), 0);
                        imageBottomLeft = new Point(0, replacementMat.get(2).height());
                        imageBottomRight = new Point(replacementMat.get(2).width(), replacementMat.get(2).height());
                        points2 = new MatOfPoint2f(imageTopLeft, imageTopRight, imageBottomLeft, imageBottomRight);
